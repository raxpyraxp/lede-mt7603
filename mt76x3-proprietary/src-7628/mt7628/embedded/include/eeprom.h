...
#endif
#elif (CONFIG_RT_SECOND_CARD == 7628)
...
#define EEPROM_DEFAULT_FILE_PATH	"/etc_ro/Wireless/MT7628_EEPROM.bin"
#endif

#if (CONFIG_RT_FIRST_CARD == 7603 || CONFIG_RT_SECOND_CARD == 7603)
#define EEPROM_DEFAULT_FILE_PATH        "/etc/wireless/MT7603_EEPROM.bin"
#endif
...
#if defined(RTMP_MAC_USB) || defined(RT3883) || defined(RTMP_FLASH_SUPPORT)
